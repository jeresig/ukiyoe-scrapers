        ...
        scrape: [
            ...
            },
            {
                extract: {
                    ...
                    title_en: ["//text()[contains(.,'英語名:')]/following-sibling::input/@value", function(val, data) {
                        data.title += " (" + val + ")";
                    }],
                    ...
                    "images[]": ["//input[@type='image'][contains(@src,'U')]/@src", function(val) {
                        return val.replace(/m.jpg/, ".jpg");
                    }],
                    "_ids[]": function(data) {
                        if (data.images) {
