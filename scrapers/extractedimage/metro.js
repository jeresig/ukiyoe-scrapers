exports.extract = {
	...
	date: [ "//td[contains(b/text(), '出版年月日')]/following-sibling::td/text()[1]", date => date.replace( /.*\((.*?)\).*/, "$1" ) ],
	description: "//td[contains(b/text(), '分類')]/following-sibling::td",
	source_image: "//img[contains(@src, 'jpg')]/@src"
};

exports.genURL = id => "http://metro.tokyo.opac.jp/tml/tpic/cgi-bin/detail.cgi?Kbseqid=" + id + "&Sryparam=001";
