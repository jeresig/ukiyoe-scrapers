    ...
    scrape: [
        ...
        },
        {
            extract: {
                ...
                artists: ["//li[contains(text(),'Artist:')]/a", val => val.replace(/,[\s\S]*$/, "")],
                dimensions: "//li[contains(text(),'Dimensions:')]/span",
                description: ["//li[contains(text(),'Catalogue Description:')]/span", val => val.replace("read more...", "")],
                "images[]": ["//img[@id='main-image']/@src", (val, data) => {
