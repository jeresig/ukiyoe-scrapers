exports.extract = {
	...
	artist: [ '//li[contains(text(), "Creator(s):")]//a || //li[contains(text(), "Related Names:")]//a', function( artist ) {
		return artist.split( /,\s*/ ).slice( 0, -1 ).join( " " );
	} ],
...
exports.genURL = function( id ) {
	return "http://www.loc.gov/pictures/collection/jpd/item/" + id + "/";
}
